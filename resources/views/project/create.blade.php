    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <!-- Form Project Create -->
                    <form action="{{route('projectlist.store')}}" class="needs-validation edugladeform formhide"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="project_name" name="project_name"
                                        aria-describedby="emailHelp" placeholder="Enter Youe email" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="email" class="form-control" id="description"
                                        ...
                                        placeholder="Enter Your Project Description" required></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="start-date form-control" name="planned_start_date"
                                        value="" readonly placeholder="Enter Your Planned Start Date" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Planned End Date </label>
                                    <input type="text" class="end-date form-control" name="planned_end_date" value=""
                                        readonly placeholder="Enter Your Planned End Date " required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Actual Start Date </label>
                                    <input type="text" class="start-date form-control" name="actual_start_date" value=""
                                        readonly placeholder="Enter Your Actual Start Date" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Actual End Date </label>
                                    <input type="text" class="end-date form-control" name="actual_end_date" value=""
                                        readonly placeholder="Enter Your Actual End Date " required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="user_id" id="user_id" class="form-control" required>
                                        ...
                                        <option value="{{$Ueser['id']}}">{{$Ueser['name']}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
